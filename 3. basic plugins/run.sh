...
aws iam attach-role-policy --role-name terraform_eks_node --policy-arn arn:aws:iam::aws:policy/CloudWatchAgentServerPolicy
...
helm install argocd argocd/argo-cd -f argocd_values.yaml \
